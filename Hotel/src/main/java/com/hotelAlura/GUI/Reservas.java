...
public class Reservas extends JPanel {
	...
	public void calcularValor() {
		if (this.dateEntra.getDate() != null && this.dateSalida.getDate() != null && (this.dateEntra.getDate().getTime() < this.dateSalida.getDate().getTime())) {
	...
	public void guardarReserva() {
		if (this.dateEntra.getDate() != null && this.dateSalida.getDate() != null && (this.dateEntra.getDate().getTime() < this.dateSalida.getDate().getTime())) {
			...
			JOptionPane.showMessageDialog(this, "Faltan datos o estan mal las fechas");
		}
	}
}
