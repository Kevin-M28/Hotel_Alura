		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addGap(27).addGroup(groupLayout
						.createParallelGroup(Alignment.LEADING).addGroup(groupLayout.createSequentialGroup()
								...
								.addGap(18).addComponent(btnEspecifico, GroupLayout.PREFERRED_SIZE, 112,
						...
						.addComponent(pruebaJScrollPane, GroupLayout.DEFAULT_SIZE, 611, Short.MAX_VALUE)
						.addContainerGap()));
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup().addGap(176)
								...
								.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
										.addComponent(btnTodos, GroupLayout.PREFERRED_SIZE, 35,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(btnEspecifico, GroupLayout.PREFERRED_SIZE, 35,
												GroupLayout.PREFERRED_SIZE)))
