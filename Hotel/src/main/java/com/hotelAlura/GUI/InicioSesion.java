...
public class InicioSesion {
	...
	public InicioSesion() {
		...
		btnIniciarSe.setFocusable(false);
		btnIniciarSe.setContentAreaFilled(false);
		btnIniciarSe.setIcon(new ImageIcon(InicioSesion.class.getResource("/com/hotelAlura/GUI/Imagenes/login.png")));
		btnIniciarSe.setSelectedIcon(
				new ImageIcon(InicioSesion.class.getResource("/com/hotelAlura/GUI/Imagenes/login.png")));
