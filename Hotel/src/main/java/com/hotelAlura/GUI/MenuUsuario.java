...
public class MenuUsuario {
	...
	public MenuUsuario(Cliente c1) {
		...
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup().addContainerGap()
						.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
								.addComponent(panelContenedor, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 698,
										Short.MAX_VALUE)
								.addComponent(panelMenu, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 698,
										Short.MAX_VALUE))
						.addContainerGap()));
		...
		gl_panelMenu.setHorizontalGroup(gl_panelMenu.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelMenu.createSequentialGroup().addGap(27)
						.addGroup(gl_panelMenu.createParallelGroup(Alignment.TRAILING, false)
								.addComponent(btnMiUsuario, Alignment.LEADING, GroupLayout.DEFAULT_SIZE,
										GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(btnSalir, Alignment.LEADING, GroupLayout.DEFAULT_SIZE,
										GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(lblNombreUser, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE)
								.addComponent(btnReservar, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 175,
										Short.MAX_VALUE))
						.addContainerGap(28, Short.MAX_VALUE)));
		gl_panelMenu.setVerticalGroup(gl_panelMenu.createParallelGroup(Alignment.LEADING).addGroup(gl_panelMenu
				.createSequentialGroup().addGap(93)
				.addComponent(lblNombreUser, GroupLayout.PREFERRED_SIZE, 41, GroupLayout.PREFERRED_SIZE).addGap(99)
				.addComponent(btnMiUsuario, GroupLayout.PREFERRED_SIZE, 66, GroupLayout.PREFERRED_SIZE).addGap(47)
				.addComponent(btnReservar, GroupLayout.PREFERRED_SIZE, 64, GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(ComponentPlacement.RELATED, 180, Short.MAX_VALUE).addComponent(btnSalir).addGap(35)));
